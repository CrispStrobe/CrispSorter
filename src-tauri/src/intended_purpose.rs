...
mod tests {
    ...
    fn a_fresh_install_is_not_acknowledged_and_the_gate_refuses() {
        ...
        // lower-case spelling this used to assert never appeared in the text, so
        // the check had always failed — unnoticed, because the lib test target
        // did not compile on this branch until 2026-08-01.
