...
pub enum EmbedderModel {
    ...
    /// Snowflake/snowflake-arctic-embed-l-v2.0 — 1024d, 8192 ctx.
    SnowflakeArcticLv2,
...
impl EmbedderModel {
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            EmbedderModel::PixieRuneV1          => "PIXIE-Rune-v1.0 (6k ctx, 74 languages)",
            EmbedderModel::SnowflakeArcticLv2   => "Snowflake Arctic-L v2.0 (8k ctx, 1024d)",
    ...
    pub fn max_tokens(&self) -> usize {
        match self {
            ...
            EmbedderModel::PixieRuneV1        => 6144,
            EmbedderModel::SnowflakeArcticLv2 => 8192,
