...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler({
            ...
            index::tauri_commands::index_token_highlight,
            ...
            sync::tauri_commands::sync_get_conflict_policy,
            sync::tauri_commands::sync_set_conflict_policy,
            sync::tauri_commands::sync_list_conflicts,
            sync::tauri_commands::sync_ack_conflict,
            sync::tauri_commands::sync_accept_remote_conflict,
            sync::tauri_commands::transfer_queue_status,
            sync::tauri_commands::transfer_queue_cancel,
            sync::tauri_commands::offline_queue_status,
            sync::tauri_commands::offline_queue_list,
            sync::tauri_commands::offline_queue_retry_failed,
            sync::tauri_commands::offline_queue_purge_failed,
            sync::tauri_commands::offline_queue_replay,
            ...
            sync::tauri_commands::sync_offline_enqueue,
            sync::tauri_commands::sync_offline_cancel,
            sync::tauri_commands::sync_pair_list,
            sync::tauri_commands::sync_pair_upsert,
            sync::tauri_commands::sync_pair_delete,
            sync::tauri_commands::sync_pair_plan,
            sync::tauri_commands::sync_pair_runs,
            sync::tauri_commands::sync_pair_remote_plan,
            sync::tauri_commands::sync_pair_compare,
            sync::tauri_commands::sync_pair_pull,
            sync::tauri_commands::sync_pair_push,
            ...
            sync::tauri_commands::proxy_set_password,
            sync::tauri_commands::proxy_test_connection,
            ...
            sync::tauri_commands::backup_job_list,
            sync::tauri_commands::backup_job_upsert,
            sync::tauri_commands::backup_job_delete,
            sync::tauri_commands::backup_job_runs,
            sync::tauri_commands::backup_job_due,
            sync::tauri_commands::backup_job_scheduler_snapshot,
            sync::tauri_commands::backup_job_snapshot_list,
            sync::tauri_commands::backup_job_restore,
            ...
            drives::tauri_commands::drive_oauth_refresh,
            drives::tauri_commands::drive_oauth_revoke,
            drives::tauri_commands::drive_list_dir,
            drives::tauri_commands::drive_search,
            drives::tauri_commands::drive_stat,
            drives::tauri_commands::drive_capabilities,
            drives::tauri_commands::drive_create_dir,
            ...
            drives::tauri_commands::drive_mount,
            drives::tauri_commands::drive_unmount,
            drives::tauri_commands::drive_mount_status,
            drives::tauri_commands::drive_read_file,
            drives::tauri_commands::drive_write_file,
            drives::tauri_commands::drive_delta_upload,
            drives::tauri_commands::drive_delta_download,
            drives::tauri_commands::drive_upload_resumable,
            drives::tauri_commands::drive_download_resumable,
            ...
            index::tauri_commands::index_set_doc_status,
            ...
            index::tauri_commands::embedder_model_license,
            index::tauri_commands::embedder_accept_model_license,
            index::tauri_commands::index_benchmark_embedder,
            index::tauri_commands::index_find_similar,
            ...
            pdf_ops::tauri_commands::pdf_linearize,
            pdf_ops::tauri_commands::pdf_repair,
