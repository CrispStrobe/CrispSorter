...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler({
            ...
            sync::tauri_commands::sync_offline_list,
            sync::tauri_commands::sync_offline_stats,
            sync::tauri_commands::sync_offline_enqueue,
            sync::tauri_commands::sync_offline_cancel,
            sync::tauri_commands::sync_offline_retry_failed,
            sync::tauri_commands::sync_offline_purge,
