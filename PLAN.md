...
- [>] **Actionable search results.** From any result: reveal/open in context,
  ...
  - [>] Provider-aware duplicate handling is in progress: duplicate candidates
    with `crisp+drive://` provenance now open in the registered-drive browser
    instead of being passed to the local opener. Mutation/undo remains open.
...
- [>] Add archive browsing, generic text/code editing, saved searches as
  ...
  - [x] `.caf`/`.cidx` archive browsing and archive-context provenance are
